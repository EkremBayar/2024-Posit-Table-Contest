...
The data in this project was collected from Transfermarkt by using the web scraping method. It contains the personal information of each player in top 5 leagues as known La Liga - Spain, Premier League - England, Serie A - Italy, Bundesliga - Germany and Ligue 1 - France. However, I preferred to use two league creating this app and those are La Liga - Spain and Premier League - England. There are 1022 players in total in these two leagues. You can find the dataset in the [App/data folder](https://github.com/EkremBayar/2024-Posit-Table-Contest/tree/main/App/data).
